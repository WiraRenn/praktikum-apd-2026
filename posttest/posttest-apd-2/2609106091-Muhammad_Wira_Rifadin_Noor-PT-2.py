...
total_harga = (harga_merchandise[0] + harga_merchandise[1] + harga_merchandise[2] + harga_merchandise[3] + harga_merchandise[4] + harga_merchandise[5])
total_harga = total_harga + bungkus_kado
